...
$perpustakaan = query('SELECT * FROM petugas');
        ...
        if( tambah1($_POST) > 0 ) {
            echo "
                <script>
                    ...
                    document.location.href='tabel_petugas.php';
                </script> ";
        } else {
            echo "
                <script>
    ...
    if(isset($_POST["cari"]) ) {
        $perpustakaan = cari1($_POST["keyword"]);
    }
    else{
        $perpustakaan = query('SELECT * FROM petugas');
    }
...
<div id="modal-centerr" class="uk-flex-top" uk-modal>
    <div class="uk-modal-dialog uk-modal-body uk-margin-auto-vertical">
        ...
        <h3 class="uk-text-center">Tambahkan Data</h3>
        <form class="uk-form-horizontal uk-margin-large" action="proses_edit1.php" method="post">
        ...
        <table class="uk-text-center uk-table uk-table-justify uk-table-divider">
                ...
                <?php foreach ($perpustakaan as $siswa ) { ?>
                     ...
                     <tr class='uk-padding'>
                         ...
                         <td>
                             <a class="uk-button uk-button-primary" href="edit1.php?id=<?php echo $siswa['id']; ?>">Edit</a> | 
                             <a class="uk-button uk-button-danger" href="hapus1.php?id=<?php echo $siswa['id']; ?>">Hapus</a>
                         </td>
                         </tr>
             <?php
                 }		
