...
if (isset($_POST['submit'])) {
 ...
 $tgl_kembali = strtotime("+5 day", strtotime($tgl_pinjam)); // +7 hari dari tgl peminjaman
 $tgl_kembali = date('Y-m-d', $tgl_kembali); // format tgl peminjaman tahun-bulan-hari

 $q = $conn->query("INSERT INTO pinjam (nama, judul, tgl_pinjam, tgl_kembali) VALUES ('$nama', '$judul', '$tgl_pinjam', '$tgl_kembali') ");
    ...
    <div id="offcanvas-push"  uk-offcanvas="mode: push; overlay: true">
        <div class="uk-offcanvas-bar">
            ...
            <ul class="uk-nav uk-nav-default">
                ...
                <li><a href="#" class="uk-h3"><span class="uk-margin-small-right" uk-icon="icon:  thumbnails"></span>Peminjaman</a></li>
...
<div id="modal-center" class="uk-flex-top" uk-modal>
   ...
   <table class="uk-text-center uk-table uk-table-justify uk-table-divider">
    ...
    $q = $conn->query("SELECT pinjam.* , siswa.nama, buku.judul FROM(( pinjam
    INNER JOIN siswa ON siswa.id = pinjam.nama)
    INNER JOIN buku ON buku.id = pinjam.judul)");
