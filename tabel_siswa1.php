		...
		<div id="offcanvas-push"  uk-offcanvas="mode: push; overlay: true">
			<div class="uk-offcanvas-bar">
				...
				<ul class="uk-nav uk-nav-default">
					...
					<li><a href="#" class="uk-h3"><span class="uk-margin-small-right" uk-icon="icon: users"></span>Tabel siswa</a></li>
        ...
        if( tambah2($_POST) > 0 ) {
            echo "
                <script>
                    ...
                    document.location.href='tabel_siswa1.php';
                </script> ";
        } else {
            echo "
                <script>
...
<div id="modal-centerr" class="uk-flex-top" uk-modal>
    <div class="uk-modal-dialog uk-modal-body uk-margin-auto-vertical">
        ...
        <h3 class="uk-text-center">Tambahkan Data</h3>
        <form class="uk-form-horizontal uk-margin-large" action="proses_edit2.php" method="post">
        ...
        <table class="uk-text-center uk-table uk-table-justify uk-table-divider">
                ...
                <?php foreach ($perpustakaan as $siswa ) { ?>
                     ...
                     <tr class='uk-padding'>
                         ...
                         <td>
                             <a class="uk-button uk-button-primary" href="edit2.php?id=<?php echo $siswa['id']; ?>">Edit</a> | 
                             <a class="uk-button uk-button-danger" href="hapus2.php?id=<?php echo $siswa['id']; ?>">Hapus</a>
                         </td>
                         </tr>
             <?php
                 }		
